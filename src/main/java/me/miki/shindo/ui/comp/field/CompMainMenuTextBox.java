package me.miki.shindo.ui.comp.field;
	...
	public void draw(int mouseX, int mouseY, float partialTicks) {
	    ...
	    if(icon != null && title != null) {
			...
			if(this.getText().isEmpty()) {
				...
				nvg.drawText(title, this.getX() + 16, this.getY() + (this.getHeight() / 2) - (nvg.getTextHeight(text, halfHeight, Fonts.REGULAR) / 2) + 1,  ColorHelper.applyAlpha(fontColor, (int) (animation.getValue() * 255)), halfHeight, Fonts.REGULAR);
				nvg.restore();
			}
	    }
