...
import me.miki.shindo.helpers.animation.AnimationEngine;
...
public class ClickGuiCategoryButton extends CategoryManager{
	...
	public void renderButton(){
		...
		if(animation.getAnimationValue() >=x+1) {
			RoundedHelper.drawRoundedRect(x, y, animation.getAnimationValue(), y+h, 5, new Color(191,226,246,255).getRGB());
