...
public class MusicCategory extends Category {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		nvg.drawText(currentMusic == null || !musicManager.isPlaying() ? LegacyIcon.PLAY : LegacyIcon.PAUSE, this.getX() + (this.getWidth() / 2) - 8, this.getY() + this.getHeight() - 21.5F,
				palette.getFontColor(ColorType.NORMAL), 16, Fonts.LEGACYICON);
		
		nvg.drawText(LegacyIcon.BACK, this.getX() + (this.getWidth() / 2) - 33, this.getY() + this.getHeight() - 21.5F,
				palette.getFontColor(ColorType.NORMAL), 16, Fonts.LEGACYICON);
		
		nvg.drawText(LegacyIcon.FORWARD, this.getX() + (this.getWidth() / 2) + 17, this.getY() + this.getHeight() - 21.5F,
				palette.getFontColor(ColorType.NORMAL), 16, Fonts.LEGACYICON);
