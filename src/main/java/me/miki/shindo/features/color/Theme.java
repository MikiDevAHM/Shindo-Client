...
public enum Theme {
	...
	public Color getDarkBackgroundColor(int alpha) {
		return ColorHelper.applyAlpha(darkBackgroundColor, alpha);
	}

	public Color getNormalBackgroundColor(int alpha) {
		return ColorHelper.applyAlpha(normalBackgroundColor, alpha);
	}

	public Color getDarkFontColor(int alpha) {
		return ColorHelper.applyAlpha(darkFontColor, alpha);
	}

	public Color getNormalFontColor(int alpha) {
		return ColorHelper.applyAlpha(normalFontColor, alpha);
	}
