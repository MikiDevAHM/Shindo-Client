package me.miki.shindo.features.nanovg;
...
import me.miki.shindo.features.nanovg.asset.AssetManager;
import me.miki.shindo.features.nanovg.font.Font;
import me.miki.shindo.features.nanovg.font.FontManager;
...
public class NanoVGManager {
	...
	public void drawGradientRect(float x, float y, float width, float height, Color color1, Color color2) {
		...
		NanoVG.nvgFillPaint(nvg, NanoVG.nvgLinearGradient(nvg, x + width / 2 - (max / 2) * MathHelper.cos(tick), y + height / 2 - (max / 2) * MathHelper.sin(tick), x + width / 2 + (max / 2) * MathHelper.cos(tick), y + height / 2 + (max + 2f) * MathHelper.sin(tick), nvgColor1, nvgColor2, bg));
		NanoVG.nvgFill(nvg);
	}
	...
	public void drawGradientOutlineRoundedRect(float x, float y, float width, float height, float radius, float strokeWidth, Color color1, Color color2) {
		...
		NanoVG.nvgStrokeWidth(nvg, strokeWidth);
		NanoVG.nvgStrokePaint(nvg, NanoVG.nvgLinearGradient(nvg, x + width / 2 - (max / 2) * MathHelper.cos(tick), y + height / 2 - (max / 2) * MathHelper.sin(tick), x + width / 2 + (max / 2) * MathHelper.cos(tick), y + height / 2 + (max + 2f) * MathHelper.sin(tick), nvgColor1, nvgColor2, bg));
		NanoVG.nvgStroke(nvg);
	}
	...
	public void drawGradientShadow(float x, float y, float width, float height, float radius, Color color1, Color color2) {
		...
		for(float f = 10; f > 0; f--) {
			drawGradientOutlineRoundedRect(x - (f / 2), y - (f / 2), width + f, height + f, radius + 2, f, ColorHelper.applyAlpha(color1, alpha), ColorHelper.applyAlpha(color2, alpha));
