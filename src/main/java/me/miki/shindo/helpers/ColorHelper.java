...
public class ColorHelper {
    ...
    public static Color interpolateColors(int speed, int index, Color start, Color end) {
        ...
        return ColorHelper.interpolateColorHue(start, end, angle / 360f);
    }
    ...
    private static Color interpolateColorHue(Color color1, Color color2, float amount) {
        ...
        return new Color(resultColor.getRed(), resultColor.getGreen(), resultColor.getBlue(), MathHelper.interpolateInt(color1.getAlpha(), color2.getAlpha(), amount));
    }
