...
import me.miki.shindo.events.impl.*;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private float getFOVModifier(float partialTicks, boolean useFOVSetting)
    {
        ...
        else
        {
            ...
            EventZoomFov event = new EventZoomFov(Reflector.ForgeHooksClient_getFOVModifier.exists() ? Reflector.callFloat(Reflector.ForgeHooksClient_getFOVModifier, this, entity, block, partialTicks, f): f);
            event.call();
    ...
    private void hurtCameraEffect(float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase)
        {
            ...
            if (entitylivingbase.getHealth() <= 0.0F)
            {
                ...
                adjustHurtCameraEffect(40.0F - 8000.0F / (f1 + 200.0F), 0.0F, 0.0F, 1.0F);
            }
            ...
            adjustHurtCameraEffect(-f2, 0.0F, 1.0F, 0.0F);
            adjustHurtCameraEffect(-f * 14.0F, 0.0F, 0.0F, 1.0F);
            adjustHurtCameraEffect(f2, 0.0F, 1.0F, 0.0F);
        }
    }
    ...
    public float modifyEyeHeight(Entity entity, float partialTicks) {
        ...
        Mod mod = Shindo.getInstance().getModManager().getMod("Animation");
        Setting sneakSetting = Shindo.getInstance().getSettingManager().getSettingByName("Sneak Animation");

        return mod.isToggled() && sneakSetting.isCheckToggled() ? previousHeight + (height - previousHeight) * partialTicks : entity.getEyeHeight();
    }
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        Entity entity = this.mc.getRenderViewEntity();
        float f = modifyEyeHeight(entity, partialTicks);
        ...
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (world != null)
            {
                ...
                for (int i = 0; i < 256; ++i)
                {
                    ...
                    float f16 = overrideGamma(mc.gameSettings);
                    float f17 = 1.0F - f8;
                    float f13 = 1.0F - f9;
                    float f14 = 1.0F - f10;
    ...
    public void eventAssessor(EntityPlayerSP entityPlayerSP, float yaw, float pitch) {
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (this.mc.inGameHasFocus && flag)
        {
            ...
            if (this.mc.gameSettings.smoothCamera)
            {
                ...
                eventAssessor(mc.thePlayer, f2, f3 * (float)i);
            }
            else
            {
                this.smoothCamYaw = 0.0F;
    ...
    public boolean overrideWetBlockHighlight(Entity entity, Material materialIn) {
        ...
        EventBlockHighlightRender event = new EventBlockHighlightRender(mc.objectMouseOver, mc.timer.renderPartialTicks);
        event.call();
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        if (!this.debugView)
        {
            ...
            if (this.mc.objectMouseOver != null && overrideWetBlockHighlight(entity, Material.water) && flag1)
            {
        ...
        if (flag1 && this.mc.objectMouseOver != null && overrideBlockHighlight(entity, Material.water))
        {
