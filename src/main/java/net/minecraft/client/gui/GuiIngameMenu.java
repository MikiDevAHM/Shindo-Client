...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(31, this.width / 2 - 100, this.height / 4 + 72 + i, 200, 20, "Shindo Client"));
        this.buttonList.add(new GuiButton(0, this.width / 2 + 2, this.height / 4 + 96 + i, 98, 20, I18n.format("menu.options")));
