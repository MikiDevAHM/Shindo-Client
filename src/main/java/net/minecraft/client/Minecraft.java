...
import me.miki.shindo.events.impl.BorderlessEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Shindo.NAME + " Client " + Shindo.VERSION + " | by " + Shindo.AUTHOR);
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                // EVENT KEY IMPLEMENTATION
                if ( Keyboard.getEventKeyState() && Minecraft.getMinecraft().currentScreen == null ) new KeyEvent(k).call();
        ...
        if (this.theWorld != null)
        {
            ...
            if (!this.isGamePaused)
            {
                try {
                    ...
                    ShindoLogger.error("Effect Renderer Exception!", e);
                }
