...
public abstract class World implements IBlockAccess
{
    ...
    public long setCelestialAngle(WorldInfo instance) {
        if (Shindo.getInstance().getModManager().getMod("TimeChanger").isToggled()) {
            return (long) (instance.getWorldTime() *
            		Shindo.getInstance().getSettingsManager().getSettingByModAndName("TimeChanger", "Speed").getCurrentNumber() +
            		Shindo.getInstance().getSettingsManager().getSettingByModAndName("TimeChanger", "Offset").getCurrentNumber());
        }
    ...
    {
    		return this.provider.calculateCelestialAngle(setCelestialAngle(this.worldInfo), partialTicks);
    }
