...
import me.miki.shindo.api.hooks.ChunkHook;
...
public class Chunk
{
    ...
    {
    	if (Shindo.getInstance().getOptionManager().getOptionByName("Chunk Optimization").isCheckToggled()) ChunkHook.getBlockState((Chunk) (Object) this, pos);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (j1 > 0)
                    {
                        if (j >= i1)
                        {
                            this.relightBlock(i, Shindo.getInstance().getOptionManager().getOptionByName("Chunk Optimization").isCheckToggled() ? j - 1 : j + 1, k);
                        }
                    }
                    else if (j == i1 - 1)
                    {
