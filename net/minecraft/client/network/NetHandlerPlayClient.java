...
import me.miki.shindo.api.hooks.NetHandlerPlayClientHook;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    {
    	if (Shindo.getInstance().getOptionManager().getOptionByName("Resource Exploit Fix").isCheckToggled() && !NetHandlerPlayClientHook.validateResourcePackUrl((NetHandlerPlayClient) (Object) this, packetIn)) return;
