...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    protected void writePing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn) {
    	...
    	if (Shindo.getInstance().getSettingsManager().getSettingByModAndName("Tablist", "Mode").getCurrentMode().equalsIgnoreCase("Modern")) {
    		Shindo.getInstance().getFontHelper().size15.drawString(networkPlayerInfoIn.getResponseTime() + " ", p_175245_2_ + p_175245_1_ - 11 - Shindo.getInstance().getFontHelper().size15.getStringWidth(networkPlayerInfoIn.getResponseTime() + " ") / 2, p_175245_3_ + 1, pingColor.getRGB());
    	} else {
    		mc.fontRendererObj.drawString(networkPlayerInfoIn.getResponseTime() + " ",  p_175245_2_ + p_175245_1_ - 11 - mc.fontRendererObj.getStringWidth(networkPlayerInfoIn.getResponseTime() + " ") / 2, p_175245_3_, pingColor.getRGB());
    	}
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                if(Shindo.getInstance().getModManager().getMod("NickHider").isToggled() && s1.contains(mc.getSession().getUsername())){
                    s1 = s1.replaceAll(mc.getSession().getUsername(), EnumChatFormatting.GOLD + Shindo.getInstance().getSettingsManager().getSettingByModAndName("NickHider", "Nickname").getText());
                }
                ...
                {
                	if (Shindo.getInstance().getModManager().getMod("Tablist").isToggled()) {
                		if (Shindo.getInstance().getSettingsManager().getSettingByModAndName("Tablist", "Mode").getCurrentMode().equalsIgnoreCase("Modern")) {
                            s1 = EnumChatFormatting.ITALIC + s1;
                            Shindo.getInstance().getFontHelper().size15.drawStringWidthShadow(s1, (float)j2, (float)k2, -1862270977);
                		} else {
                            s1 = EnumChatFormatting.ITALIC + s1;
                ...
                else
                {
                	if (Shindo.getInstance().getModManager().getMod("Tablist").isToggled()) {
                		if (Shindo.getInstance().getSettingsManager().getSettingByModAndName("Tablist", "Mode").getCurrentMode().equalsIgnoreCase("Modern")) {
                			Shindo.getInstance().getFontHelper().size15.drawStringWidthShadow(s1, (float)j2, (float)k2 , -1);
                		} else {
                ...
                if (Shindo.getInstance().getModManager().getMod("Tablist").isToggled() && Shindo.getInstance().getSettingsManager().getSettingByModAndName("Tablist", "Show Ping").isCheckToggled()) {
