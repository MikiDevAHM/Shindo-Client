...
import me.miki.shindo.event.impl.GuiOpenEvent;
...
import me.miki.shindo.ui.titlescreen.MainMenu;
import me.miki.shindo.util.animation.Delta;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.drawSplashScreen(getTextureManager());
        this.initStream();
        ...
        SplashProgress.setProgress(1, "[Minecraft] Iniciando Model Manager...");
        this.modelManager = new ModelManager(this.textureMapBlocks);
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        SplashProgress.setProgress(2, "[Minecraft] Iniciando Render Manager...");
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        SplashProgress.setProgress(3, "[Minecraft] Iniciando Item Renderer...");
        this.itemRenderer = new ItemRenderer(this);
        this.mcResourceManager.registerReloadListener(this.renderItem);
        SplashProgress.setProgress(4, "[Minecraft] Iniciando Entity Renderer...");
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        SplashProgress.setProgress(5, "[Minecraft] Iniciando Render Global...");
        this.renderGlobal = new RenderGlobal(this);
        this.mcResourceManager.registerReloadListener(this.renderGlobal);
        this.guiAchievement = new GuiAchievement(this);
        GlStateManager.viewport(0, 0, this.displayWidth, this.displayHeight);
        SplashProgress.setProgress(6, "[Minecraft] Iniciando Effect Renderer...");
        ...
        /*
         * 
         * Shindo Startup Method
         * 
         */
        Shindo.getInstance().startup();
    ...
    {
    	if (Shindo.getInstance().getOptionManager().getOptionByName("Hit Dalay Fix").isCheckToggled()) leftClickCounter = 0;
        ...
        if (this.leftClickCounter <= 0)
        {
            ...
            if (this.objectMouseOver == null)
            {
                ...
                {
                    this.leftClickCounter = Shindo.getInstance().getOptionManager().getOptionByName("Hit Dalay Fix").isCheckToggled() ? 10 : (int) 0.5F;
                }
            }
            else
            {
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Shindo.getInstance().getIpc().update("Playing SinglePlayer", "In Game");
    }
