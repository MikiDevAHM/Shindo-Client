...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_)
    {
        ...
        float rotAmount;
        float f5;
        if (Shindo.getInstance().getModManager().getMod("ItemPhysics").isToggled()) {
            ...
            else
            {
                ...
                f1 = -0.125f; //MathHelper.sin(((float)itemIn.getAge() + p_177077_8_) / 10.0F + itemIn.hoverStart) * 0.1F + 0.1F;
                if(!flag) f1 = -0.175f;
           ...
           if (item == null) {
              ...
              GlStateManager.translate((float)p_177077_2_, (float)p_177077_4_ + f1 + 0.25F * f2, (float)p_177077_6_);
              if (flag || this.renderManager.options != null) {
                 speed = (((float)itemIn.getAge() + p_177077_8_) / 20.0F + itemIn.hoverStart) * 57.295776F;
                 GlStateManager.rotate(speed, 0.0F, 1.0F, 0.0F);
              }

              if (!flag) {
                 speed = -0.0F * (float)(i - 1) * 0.5F;
                 rotAmount = -0.0F * (float)(i - 1) * 0.5F;
                 f5 = -0.046875F * (float)(i - 1) * 0.5F;
                 GlStateManager.translate(speed, rotAmount, f5);
              }
