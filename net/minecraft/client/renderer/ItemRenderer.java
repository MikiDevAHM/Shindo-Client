...
public class ItemRenderer
{
    ...
    {
        if (Shindo.getInstance().getSettingsManager().getSettingByModAndName("Animation", "Block Animation").isCheckToggled()) {
            ...
            if (this.itemToRender != null)
            {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case DRINK:
                            ...
                            this.transformFirstPersonItem(f, animationModToggled &&
                                    Shindo.getInstance().getSettingsManager().getSettingByModAndName("Animation", "Eat/Drink Animation").isCheckToggled()
                                    ? f1 : 0.0F);
                            break;
                        case BLOCK:
                            this.transformFirstPersonItem(f, animationModToggled &&
                            		Shindo.getInstance().getSettingsManager().getSettingByModAndName("Animation", "Block Animation").isCheckToggled()
                                    ? f1 : 0.0F);
                            this.doBlockTransformations();
                            break;
                        case BOW:
                            this.transformFirstPersonItem(f, animationModToggled &&
                            		Shindo.getInstance().getSettingsManager().getSettingByModAndName("Animation", "Bow Animation").isCheckToggled()
                                    ? f1 : 0.0F);
                ...
                else
                {
                    ...
                    if (this.itemToRender.getItem() instanceof ItemFishingRod && animationModToggled &&
                    		Shindo.getInstance().getSettingsManager().getSettingByModAndName("Animation", "Fishing Rod").isCheckToggled()) {
