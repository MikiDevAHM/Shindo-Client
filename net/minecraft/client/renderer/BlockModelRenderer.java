...
public class BlockModelRenderer
{
    ...
    public static class AmbientOcclusionFace
    {
        ...
        public void updateVertexBrightness(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing facingIn, float[] quadBounds, BitSet boundsFlags)
        {
            ...
            boolean flag = blockAccessIn.getBlockState(blockpos1.offset(facingIn)).getBlock().betterSmoothLighting(blockIn);
            boolean flag1 = blockAccessIn.getBlockState(blockpos2.offset(facingIn)).getBlock().betterSmoothLighting(blockIn);
            boolean flag2 = blockAccessIn.getBlockState(blockpos3.offset(facingIn)).getBlock().betterSmoothLighting(blockIn);
            boolean flag3 = blockAccessIn.getBlockState(blockpos4.offset(facingIn)).getBlock().betterSmoothLighting(blockIn);
            float f4;
            int i1;
