package me.miki.shindo.api.logger;
...
public class EcoLogManager {
	...
	*/
	...
	public String saveConsoleToFile(String dir)
	{
		...
		{
			this.log(LoggerCasualEnum.EcoLogger, "Unable to save console log to: " + dir);
	...
	//Easier way to say logger.log(LoggerCasualEnum.ProjectInfo);
	public void info(String text)
	{
		//Log the info in a clean way with colours
		String toLog = infoColour1 + "[" + clientName + "]" + infoColour2 + " [" + getTime() + "] " + infoColour1 + "[Project Info]" + " " + infoColour2 + text + ANSI_RESET;
		System.out.println(toLog);
			
		//Add it to the ArrayList, and make it look nice
		String toLogToFile = "[" + clientName + "]" + " [" + getTime() + "] " + "[Project Info]" + " " + text;
		console.add(toLogToFile + "\n");
	}
	
	//Easier way to say logger.log("here goes a string that is a custom info message");
	public void info(String info, String text)
	{
		//Log the info in a clean way with colours
		String toLog = infoColour1 + "[" + clientName + "]" + infoColour2 + " [" + getTime() + "] " + infoColour1 + "[" + info + "]" + " " + infoColour2 + text + ANSI_RESET;
		System.out.println(toLog);
			
		//Add it to the ArrayList, and make it look nice
		String toLogToFile = "[" + clientName + "]" + " [" + getTime() + "] " + "[" + info + "]" + " " + text;
		console.add(toLogToFile + "\n");
	}
	
	//Easier way to say logger.log(LoggerWarningEnum.ProjectWarning);
	public void warn(String text)
	{
		//Log the info in a clean way with colours
		String toLog = mildWarningColour + "[" + clientName + "]" + " [" + getTime() + "] " + "[Warning]" + " " + text + ANSI_RESET;
		System.out.println(toLog);
			
		//Add it to the ArrayList, and make it look nice
		String toLogToFile = "[" + clientName + "]" + " [" + getTime() + "] " + "[Warning]" + " " + text;
		console.add(toLogToFile + "\n");
	}
	
	//Easier way to say logger.log(LoggerWarningEnum.ProjectWarning);
	public void warn(String warning, String text)
	{
		//Log the info in a clean way with colours
		String toLog = mildWarningColour + "[" + clientName + "]" + " [" + getTime() + "] " + "[" + warning + "]" + " " + text + ANSI_RESET;
		System.out.println(toLog);
	...
	//Easier way to say logger.log(LoggerWarningEnum.ProjectIssue);
	public void alert(String text)
	{
		//Log the info in a clean way with colours
		String toLog = importantWarningColour + "[" + clientName + "]" + " [" + getTime() + "] " + "[Issue]" + " " + text + ANSI_RESET;
		System.out.println(toLog);
			
		//Add it to the ArrayList, and make it look nice
		String toLogToFile = "[" + clientName + "]" + " [" + getTime() + "] " + "[Issue]" + " " + text;
		console.add(toLogToFile + "\n");
	}
	
	//Easier way to say logger.log(LoggerWarningEnum.ProjectIssue);
	public void alert(String issue, String text)
	{
		//Log the info in a clean way with colours
		String toLog = importantWarningColour + "[" + clientName + "]" + " [" + getTime() + "] " + "[" + issue + "]" + " " + text + ANSI_RESET;
		System.out.println(toLog);
	...
	//Shutdown program as well as log it in console
	public void shutdown()
	{
		this.info("Shutdown Call", "Shutting Down Program");
		System.exit(0);
	}
}
