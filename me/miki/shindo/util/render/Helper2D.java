...
package me.miki.shindo.util.render;
...
import me.miki.shindo.util.ColorHelper;
...
public class Helper2D {
    ...
    public static void drawPlayerHead(String name, int x, int y, int w, int h, int color) {
        if (color == 0) {
    ...
    public static ResourceLocation getHeadLocation(String username) {
        ResourceLocation playerHead = (ResourceLocation) playerHeads.getOrDefault(username,
                new ResourceLocation("shindo/heads/" + username + ".png"));
        if (!playerHeads.containsKey(username)) {
            ThreadDownloadImageData skinData = new ThreadDownloadImageData(null,
                    ...
                    new ResourceLocation("shindo/heads/steve.png"), null);
