package me.miki.shindo.ui.mods.sidebar.mods;
...
import me.miki.shindo.ui.mods.sidebar.mods.impl.type.*;
...
public class Button {
    ...
    public Button(Mod mod, Panel panel, int x, int y) {
        ...
        if (Shindo.getInstance().getSettingsManager().getSettingsByMod(mod) != null) {
            int addY = 70;
            for (Setting setting : Shindo.getInstance().getSettingsManager().getSettingsByMod(mod)) {
